...
class UserManagementViewTest {
    ...
    void navigateAsAdmin_SuccessfulNavigation() {
        ...
        assertNotNull(roles, "The UserManagementView class should be annotated with @RolesAllowed");
        assertArrayEquals(new String[]{"ROLE_ADMIN"}, roles.value(), "The UserManagementView class should be annotated with @RolesAllowed having 'ROLE_ADMIN' as its value");
    }
